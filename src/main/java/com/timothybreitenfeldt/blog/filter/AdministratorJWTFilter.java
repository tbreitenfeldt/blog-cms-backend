...
@Component
public class AdministratorJWTFilter extends OncePerRequestFilter {

    @Autowired
    AdministratorDetailsServiceImpl administratorDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (token != null && this.jwtUtil.validateToken(token)) {
            ...
            UserDetails userDetails = this.administratorDetailsServiceImpl.loadUserByUsername(username);
